...
export const redditLinks: linkBatch = {
    ...
    sites: [
      ...
      { dest: 'https://reddit.com/r/bapcsalescanada', key: 'Build a PC Sales - Canada' },
  ...
  export const apps: appList[] =  [
    [
      ...
      { icon: 'twitch', name: 'messenger', dest: 'https://twitch.tv' },
      { icon: 'twitter', name: 'twitter', dest: 'https://bsky.app' },
    ],
    [
    ...
    [
      ...
      { icon: 'wikipedia w', name: 'wikipedia', dest: 'https://en.wikipedia.org/wiki/Main_Page' },
    ],
  ];